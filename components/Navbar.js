...
export default function Navbar() {
   ...
   return (
     <>
       <nav className="container flex justify-around py-8 mx-auto bg-white sticky">
  <div className="flex items-center">
    <svg xmlns="http://www.w3.org/2000/svg" className='w-10 h-10' viewBox="0 0 512 512"><title>Fast Food</title><path d="M322 416c0 35.35-20.65 64-56 64H134c-35.35 0-56-28.65-56-64M336 336c17.67 0 32 17.91 32 40h0c0 22.09-14.33 40-32 40H64c-17.67 0-32-17.91-32-40h0c0-22.09 14.33-40 32-40" fill="none" stroke="currentColor"/><path d="M256 480h139.31a32 32 0 0031.91-29.61L463 112" fill="none" stroke="currentColor"/><path fill="none" stroke="currentColor" d="M368 112l16-64 47-16"/><path fill="none" stroke="currentColor" d="M224 112h256"/></svg>
